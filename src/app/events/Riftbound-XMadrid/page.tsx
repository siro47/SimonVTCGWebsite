...
export const metadata: Metadata = {
  title: "Riftbound - XMadrid 2025 | SimonV TCG",
  description: "Main page of Riftbound - XMadrid 2025",
  // other metadata
};
  ...
  return (
    <>
      <Breadcrumb
        pageName="Eventos"
        pageLink="events"
        subPageName="Riftbound - XMadrid 2025"
        description="Torneo Riftbound - XMadrid 2025"
      />
        ...
        <div className="mt-12">
          ...
          <div className="mt-8">
            <div className='text-sm'>
                <p className='pb-4'>La inscripción en el torneo será vía Online mediante el link de esta web o de forma presencial el sábado 8 en el stand de SimonV.</p>
            </div>
            <h1 className='text-xl font-bold pb-8 mt-8'>Detalles del evento</h1>
            <div className='text-sm'>
                <ul className='pb-4 list-disc'>
                    <li className="p-2">Limitado a 64 plazas.</li>
                    <li className="p-2">Mañana Suizo Bo1 + Tarde Top8</li>
                </ul>
            </div>
            <h1 className='text-xl font-bold pb-8 mt-8'>Premios</h1>
            <p className='pb-4'>2 sobres para todos los participantes</p>
            <div className="grid grid-cols-2 gap-x-8">
                <p className='pb-4'>Top 32: Sobre adicional</p>
                <p className='pb-4'>Top 8: 2 Sobres adicionales</p>
                <p className='pb-4'>Top 4: Tapete edición limitada</p>
                <p className='pb-4'>Subcampeón: 30€</p>
                <p className='pb-4'>Campeón: 100€</p>
            </div>
            <p className='pb-4'>*Estos premios están calculados para una participación de 64 jugadores.</p>
            <p className='pb-4'>*Precios reajustables en función del pvp de los productos</p>
          </div>
        </div>
      </div>
