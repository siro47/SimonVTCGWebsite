      ...
      <div className="container grid grid-cols-1 md:grid-cols-2">
        ...
        <div>
          ...
          <div>
            ...
            <p className="pb-4">Para jugar con el formato <strong className='text-secondary'>Twin Suns</strong>, hay diseñar tu mazo con un mínimo de <strong className="text-primary">50 cartas</strong>, que incluya un <strong className="text-primary">máximo de una copia por carta</strong>. Además se compone de <strong className="text-primary">dos líderes</strong> que tienen que coincidir en el aspecto de maldad o heroísmo y una base.</p>
